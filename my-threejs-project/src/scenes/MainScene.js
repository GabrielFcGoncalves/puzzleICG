...
export class MainScene {
    ...
    init() {
        ...
        // --- Wall Chandeliers ---
        this.lights.chanRight = new WallChandelier(this.scene);
        this.lights.chanRight.setPosition(4.9, 1.5, 1);
        this.lights.chanRight.setRotation(-Math.PI / 2);

        this.lights.chanLeft = new WallChandelier(this.scene);
        this.lights.chanLeft.setPosition(-4.9, 1.5, -1);
        this.lights.chanLeft.setRotation(Math.PI / 2);

        this.lights.chanBack = new WallChandelier(this.scene);
        this.lights.chanBack.setPosition(0, 2, -4.9);

        // --- Objects ---
        this.objects.room = new Room(this.scene);
        
        this.objects.cabinet = new Cabinet(this.scene);
        this.objects.cabinet.group.position.z = -3.5;

        this.objects.pBox = new PuzzleBox(this.scene);
